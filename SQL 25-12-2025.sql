...
select e.enrollment_id, e.course_name ,e.student_id from enrollments as e;
-- inner join
select s.student_id, s.student_name ,e.enrollment_id, e.course_name ,
e.student_id from students as s left join enrollments as e
on s.student_id=e.student_id;

select s.student_id, s.student_name ,e.enrollment_id, e.course_name ,
e.student_id from students as s join enrollments as e
on s.student_id=e.student_id;
...
select s.student_id, s.student_name ,e.enrollment_id, e.course_name ,
e.student_id from students as s left join enrollments as e
on s.student_id=e.student_id where enrollment_id is not NULL;

select s.student_name , count(e.enrollment_id) from students as s  join enrollments as e
on s.student_id=e.student_id group by student_name;

-- * is not use for null value will count 
select s.student_id , count(*) from students as s  join enrollments as e
on s.student_id=e.student_id group by student_id;


select s.student_id, s.student_name ,sum(e.credits) from students as s left join enrollments as e
on s.student_id=e.student_id group by student_id;


select s.student_id, s.student_name ,sum(e.credits), count(enrollment_id)
...
select s.student_id, s.student_name ,sum(e.credits), count(enrollment_id)
 from students as s left join enrollments as e
on s.student_id=e.student_id group by student_id
order by count(enrollment_id) desc limit 3 ;


select s.student_id, s.student_name ,sum(e.credits), count(enrollment_id)
 from students as s left join enrollments as e
on s.student_id=e.student_id group by student_id
order by count(enrollment_id) desc limit 3 offset 1 ;
